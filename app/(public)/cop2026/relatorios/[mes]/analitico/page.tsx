...
import { RelatorioExecutivo } from "@/components/publico16/cop/relatorio-executivo";
...
export const metadata: Metadata = {
  title: "Relatório executivo analítico · Auditoria de COP 2026",
...
export default async function RelatorioAnaliticoPage({
  ...
  // Recorte do mês: só o `de`/`ate` mudam; a meta segue a Matriz Proporcional.
  ...
  return (
    <div className="tema-institucional min-h-screen bg-tatico-fundo text-[15px] text-branco">
      <NavegacaoCop
        ...
        tituloPagina={`Relatório analítico · ${mes.rotulo}`}
      />
      ...
      <main className="pt-2">
        <div className="mx-auto max-w-5xl px-4 pt-6">
          <Link
            ...
            className="nao-imprime inline-flex min-h-11 items-center gap-1.5 text-[13px] font-semibold text-texto-suave sm:min-h-0 transition-colors hover:text-vermelho"
          >
