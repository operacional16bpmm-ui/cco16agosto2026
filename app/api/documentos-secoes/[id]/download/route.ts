...
export async function GET(
  ...
  // Baixar por id não pode furar a visibilidade por seção: só quem tem a
  // página equivalente liberada (ou o Comando/Estado-Maior, irrestritos) lê o
  // documento. Um documento sem nenhuma seção marcada (raro, cadastro
  // incompleto) fica restrito por padrão.
